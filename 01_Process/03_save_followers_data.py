...
file_path = os.path.join(current_dir, '00_html_folder', 'v3_followers_html.txt')
...
if os.path.exists(file_path):
    ...
    csv_file_path = os.path.join(current_dir, '03_results_folder', 'followers_data.csv')
    with open(csv_file_path, 'w', newline='', encoding='utf-8') as csv_file:
        ...
        txt_file_path = os.path.join(current_dir, '03_results_folder', 'followers_data.txt')
